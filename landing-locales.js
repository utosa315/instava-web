window.INSTAVA_LANDING_LOCALES = {
  de: {
    ...
    ads: ["Keine überraschende Vollbild-Videowerbung", "Beim Öffnen oder Zurückkehren startet keine Vollbild-Videowerbung. Instava enthält Werbung, sie übernimmt den Bildschirm aber nicht in Momenten, die nichts mit deiner Aktion zu tun haben."],
  ...
  es: {
    ...
    ads: ["Sin anuncios de video sorpresa a pantalla completa", "No aparece ningún anuncio de video a pantalla completa al abrir la app ni al volver. Instava contiene anuncios, pero no ocupan la pantalla en momentos ajenos a lo que haces."],
  ...
  fr: {
    ...
    ads: ["Aucune publicité vidéo plein écran surprise", "Aucune publicité vidéo plein écran ne démarre à l’ouverture ou au retour dans l’app. Instava contient des publicités, mais elles n’occupent pas l’écran à des moments sans rapport avec votre action."],
  ...
  hi: {
    ...
    ads: ["अचानक फुल-स्क्रीन वीडियो विज्ञापन नहीं", "ऐप खोलने या वापस आने पर फुल-स्क्रीन वीडियो विज्ञापन शुरू नहीं होता। Instava में विज्ञापन हैं, लेकिन वे आपके काम से अलग समय पर अचानक पूरी स्क्रीन नहीं घेरते।"],
  ...
  id: {
    ...
    ads: ["Tanpa iklan video layar penuh mendadak", "Tidak ada iklan video layar penuh saat membuka atau kembali ke aplikasi. Instava memiliki iklan, tetapi iklan tidak mengambil alih layar pada saat yang tidak berkaitan dengan tindakan Anda."],
  ...
  it: {
    ...
    ads: ["Nessuna pubblicità video a schermo intero a sorpresa", "Nessuna pubblicità video a schermo intero parte quando apri o riprendi l’app. Instava contiene annunci, ma non occupano lo schermo in momenti estranei a ciò che stai facendo."],
  ...
  ko: {
    ...
    ads: ["갑자기 뜨는 전체 화면 동영상 광고 없음", "앱을 열거나 돌아왔을 때 전체 화면 동영상 광고가 시작되지 않습니다. Instava에는 광고가 있지만, 사용자의 동작과 관계없는 순간에 갑자기 화면을 가리지 않습니다."],
  ...
  pt: {
    ...
    ads: ["Sem anúncios em vídeo de tela cheia de surpresa", "Nenhum anúncio em vídeo de tela cheia começa ao abrir ou voltar ao app. O Instava contém anúncios, mas eles não ocupam a tela em momentos sem relação com o que você está fazendo."],
  ...
  th: {
    ...
    ads: ["ไม่มีโฆษณาวิดีโอเต็มจอที่โผล่มาโดยไม่คาดคิด", "ไม่มีโฆษณาวิดีโอเต็มจอเริ่มเล่นตอนเปิดหรือกลับเข้าแอป Instava มีโฆษณา แต่จะไม่เข้าครอบเต็มหน้าจอในจังหวะที่ไม่เกี่ยวกับสิ่งที่คุณกำลังทำ"],
  ...
  tr: {
    ...
    ads: ["Sürpriz tam ekran video reklam yok", "Uygulamayı açtığında veya geri döndüğünde tam ekran video reklam başlamaz. Instava reklam içerir, ancak yaptığın işlemle ilgisiz anlarda ekranı kaplamaz."],
  ...
  vi: {
    ...
    ads: ["Không có quảng cáo video toàn màn hình bất ngờ", "Không có quảng cáo video toàn màn hình khi mở hoặc quay lại ứng dụng. Instava có quảng cáo, nhưng quảng cáo không chiếm màn hình vào những lúc không liên quan đến thao tác của bạn."],
  ...
  zh: {
    ...
    ads: ["不會突然跳出全螢幕影片廣告", "開啟 App 或切回 App 時，不會突然播放全螢幕影片廣告。Instava 含有廣告，但不會在與操作無關的時機突然占滿畫面。"],
  ...
  ar: {
    ...
    ads: ["لا إعلانات فيديو مفاجئة بملء الشاشة", "لا يبدأ إعلان فيديو بملء الشاشة عند فتح التطبيق أو العودة إليه. يحتوي Instava على إعلانات، لكنها لا تستولي على الشاشة فجأة في أوقات لا تتعلق بما تفعله."],
